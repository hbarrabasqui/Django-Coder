...
from django.contrib.auth.mixins import LoginRequiredMixin # para clases basadas en vistas
from django.contrib.auth.decorators import login_required # para clases (def)
